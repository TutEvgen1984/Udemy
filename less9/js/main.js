...
// Цикл for of применяется не только к массивам, особенно хорошо он работает с html-элементами.
...
// в конце это - висячая запятая, облегчает добавление/удаление/сортировку ключей
...
class UserClass { // Имя не должно совпадать с именем Конструктора
    ...
    constructor (name, age) { // Используем ключевое слово constructor и в скобках переменные - это если нам нужно обрабатывать вводимые извне переменные. Сам constructor() является методом, как будто это  myInfo () который ниже. Здесь уже надо писать this.
        this.name = name // создали свойство объекта name равный внешной переменной name
        this.age = age // создали свойство объекта age равный внешней переменной age
