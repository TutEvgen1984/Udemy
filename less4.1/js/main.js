...
// --- Старая функция isNaN - NaN = not a number ----------------
console.log("\n IsNaN:");
// Сначала рассмотри старый код, а потом новый аналог из ES6
// Существует специальное значение NaN, с помощью которого можно проверять, что это не число.
// Старая функция isNaN возвращает нам false только в том случае если у нас переданное число

let a10 = "NaN" // старый метод говорит что это - не число NaN
let b10 = NaN // Метод работает не правильно, нам нужно чтобы только здесь было true, нужно точное сравнение с NaN
let c10 = "hello" // старый метод говорит что это - не число NaN
let d10 = 12 
