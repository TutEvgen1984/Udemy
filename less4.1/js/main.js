...
// Функция Switch - аналог if-else. Применяется когда много условий, в нем они будут нагляднее:
...
switch(true) { /* true - это то с чем мы сравниваем дальнейшие условия */
    ...
    case age < 18 && age > 0: /* проверяются 2 условия челез логику И. Если этого не написать, то при вводе -20 получим "Мой возраст меньше 18" */
    ...
    default : /* это аналог else, который срабатывает когда не было выполнено никаких действий до него */
        alert("Неправильный возраст") /* Появляется при числах <=0 b при кнопке Отмена */
}
