...
while (count < 10) {
    ...
    if (count == 4) {break} /* обязательно два равно, если одно то цикл выдаёт 0 в консоль и дальше не работает. break останавливает цикл while */
    count++ /* прибавляем к счеткичку единицу */
