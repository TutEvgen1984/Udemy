...
arr.shift() /* Выбрасывание первого элемента и массива/ D скобки ничего писать не надо */
...
// Метод PUSH (добавляемый элемент) (добавление элемента в массив в конец очереди)
...
arr3 = arr.concat(arr2) /* сначала пишем массив 1 к которому хотим присоединить, затем метод конкатенации у которого в скобках массив 2 который присоединится к первому*/

console.log("\n Написали команду arr3 = arr.concat(arr2)")

console.log("\n Новый массив arr3 = " + arr3) /* видим Первый элемент,2,Text,true,,7,21,22,23 */
