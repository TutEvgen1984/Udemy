...
let d60000 = new Date (60000)
console.log(d60000)
// Получили: Thu Jan 01 1970 07:01:00 GMT+0700 (GMT+07:00)
// Если в качестве параметра пишем число, то количество миллисекунд (1/1000 секунды), прошедших с 1 января 1970 года GMT+0. Это 60 000 миллисекунд, 1000 миллисекунд = 1 секунда. 60 секунд = 1 минута. Это целое число называется Timestamp (штамп времени, отметка времени)
...
// 6 это июнь, но у нас получился июль который должен быть 7 месяцем п осчету. Это потому что месяца начинаются с нуля.
...
// Отсчет начинаетсся с нуля с воскресенья
...
// Метод getTimezoneOffset() - возвращает разницу в минутах между местным временем и UTC
