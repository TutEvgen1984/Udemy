...
// Если закомментировать try..catch в нашей вункции, то в строке 1725 вместо undefined получим 1422 (в данном это не ошибка и код не останавливается), но бывают случаи когда код не выполняется дальше вообще
...
// Используем метод первого корневого объекта admin на основе которого сделан конструктор User: 
u1.isAdmin()
...
// Используем метод-фуекцию конструктора User:
u1.myInfo()
...
class UserClass { // Имя не должно совпадать с именем Конструктора
    constructor (name, age) {
        ...
        myInfo () { // для класса используется создание метода как для обычного объекта
            console.log("Меня зовут "+this.name+", мне "+ this.age + " лет")}
} 

let u12 = new UserClass ("Petr", 21)
console.log(u12);
// Получили: UserClass {name: 'Petr', age: 21}
