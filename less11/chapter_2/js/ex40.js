...
// ниже для 3-х полей присвоим 3 события и для всех в качестве обработчика события присвоим функцию calculate
...
function calculate () {
    ...
    // срок вклада мы будем рассчитывать в городах, поэтому мы значение поля в месяцах поделим на 12
